...
public class LRUReplacementStrategyTest
{
	...
	@Test
	public void testMultiplePagesToReplaceWithPinAndUnpinFirstReferncedLast() throws Exception
	{
		BufferFrame frame0 = strategy.createNewFrame(DummyObjectFactory.PAGE);
		BufferFrame frame1 = strategy.createNewFrame(DummyObjectFactory.PAGE);
		frame1.pin();
	...
	@Test
	public void testMultiplePagesToReplaceButOldestOnePinnedWithPinAndUnpinFirstReferencesLast() throws Exception
	{
		BufferFrame frame0 = strategy.createNewFrame(DummyObjectFactory.PAGE);
		BufferFrame frame1 = strategy.createNewFrame(DummyObjectFactory.PAGE);
		frame1.pin();
