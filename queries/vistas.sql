...
BEGIN
	...
	IF (fase > 0) THEN
		SELECT partido.idPartido, p1.nombrePais as pais1, p2.nombrePais as pais2, etapa.nombreEtapa as etapa, tanteador.scoreEquip1, tanteador.scoreEquip2, pos1.puntos as puntos1, pos2.puntos as puntos2   
		FROM partido, seleccion s1, seleccion s2, pais p1, pais p2, etapa, tanteador, posicion pos1, posicion pos2 
		WHERE s1.idSeleccion = equipoSeleccion1 AND
			  ...
			  s1.ubicaPosicion = pos1.idPosicion AND
			  s2.ubicaPosicion = pos2.idPosicion
			  ORDER BY idPartido;
	ELSE
		SELECT partido.idPartido, p1.nombrePais as pais1, p2.nombrePais as pais2, etapa.nombreEtapa as etapa, tanteador.scoreEquip1, tanteador.scoreEquip2, pos1.puntos as puntos1, pos2.puntos as puntos2
		FROM partido, seleccion s1, seleccion s2, pais p1, pais p2, etapa, tanteador, posicion pos1, posicion pos2
