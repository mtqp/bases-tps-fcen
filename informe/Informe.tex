...
\subsection{Restricciones adicionales al modelo}
	Contamos con XXX restricciones al modelo de entre las cuales se encuentran las dictadas por el Modelo de entidad relaci\'on y por restricciones propias agregadas
